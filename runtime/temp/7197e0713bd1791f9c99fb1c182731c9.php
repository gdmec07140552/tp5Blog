<?php /*a:4:{s:60:"D:\phpStudy\WWW\tp5Blog\application\admin\view\conf\add.html";i:1577007014;s:65:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\header.html";i:1577002293;s:62:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\css.html";i:1575341690;s:69:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\javascript.html";i:1575194486;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
	...
	<div class="x-body">
		<form class="layui-form" enctype="multipart/form-data">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="conf_content" placeholder="请输入字段的值" name="conf_content" class="layui-input" lay-verify="required">
				</div>
				<div class="layui-input-inline">
					<span class="x-red">*</span>
				</div>
