<?php /*a:4:{s:69:"D:\phpStudy\WWW\tp5Blog\application\admin\view\banner\banner_add.html";i:1575110149;s:65:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\header.html";i:1575088278;s:62:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\css.html";i:1575079099;s:69:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\javascript.html";i:1575098746;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
	...
	<div class="x-body">
		<form class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="link" value="" name="link_url" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<select name="author_id" id="author_id" lay-verify="required">
