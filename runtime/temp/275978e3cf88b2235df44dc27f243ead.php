...
<?php endif; ?>
    ...
    <div class="x-body">
        <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="banner_add('添加轮播图','<?php echo url("Banner/banner_add"); ?>','600','630')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
        <table class="layui-table">
            ...
            <tbody id="x-img">
                <tr>
                    ...
                    <td>
                        <img  src="/static/admin/images/banner.png" width="200" alt="">点击图片试试
                    </td>
                    <td >
