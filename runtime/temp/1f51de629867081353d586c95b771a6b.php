            ...
            <table class="layui-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span id="lbServerName"><?php echo htmlentities($_SERVER['REMOTE_ADDR']); ?></span></td>
                    </tr>
                    <tr>
                        <td>服务器IP地址</td>
                        <td><?php echo htmlentities($_SERVER['REMOTE_ADDR']); ?></td>
                    </tr>
                    <tr>
                        <td>服务器域名</td>
                        <td><?php echo htmlentities($_SERVER['SERVER_NAME']); ?></td>
                    </tr>
                    <tr>
                        <td>服务器端口 </td>
                        <td><?php echo htmlentities($_SERVER['SERVER_PORT']); ?></td>
                    </tr>
                    <tr>
                        <td>服务器IIS版本 </td>
                    ...
                    <tr>
                        <td>本文件所在文件夹 </td>
                        <td><?php echo htmlentities($_SERVER['DOCUMENT_ROOT']); ?></td>
                    </tr>
                    <tr>
                        <td>服务器操作系统 </td>
                    ...
                    <tr>
                        <td>系统所在文件夹 </td>
                        <td><?php echo htmlentities($_SERVER['SYSTEMROOT']); ?></td>
                    </tr>
                    <tr>
                        <td>服务器脚本超时时间 </td>
                        <td>30000秒</td>
                    ...
                    <tr>
                        <td>服务器的语言种类 </td>
                        <td><?php echo htmlentities($_SERVER['HTTP_ACCEPT_LANGUAGE']); ?></td>
                    </tr>
                    <tr>
