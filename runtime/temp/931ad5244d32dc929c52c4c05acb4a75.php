<?php /*a:4:{s:61:"D:\phpStudy\WWW\tp5Blog\application\admin\view\role\list.html";i:1575975062;s:65:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\header.html";i:1575088278;s:62:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\css.html";i:1575341690;s:69:"D:\phpStudy\WWW\tp5Blog\application\admin\view\common\javascript.html";i:1575194486;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <table class="layui-table">
                ...
                <tbody id="x-img">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('Role/detail'); ?>?art_id=<?php echo htmlentities($res['art_id']); ?>">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑角色" href="<?php echo url('Role/edit'); ?>?art_id=<?php echo htmlentities($res['art_id']); ?>" class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('.layui-btn-mini').on('click', function(data){
                ...
                $.get(
                    "<?php echo url('Role/ajaxIsShow'); ?>/is_show/" + is_show+"/art_id/"+art_id,
                    function(res){
                        if (res['status'] == 1)
                        {
                            // 显示状态
            ...
            $('.layui-input').on('change', function(data){
                ...
                var val = $(this).val();
                $.get(
                    "<?php echo url('Role/ajaxSort'); ?>/art_id/" + art_id + '/sort/' + val,
                    function(res){
                        if (res['status'] == 1)
                        {
                            layer.msg(res['msg'], {icon: 6});
